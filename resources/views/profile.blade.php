                ...
                <div class="rest">
                    <div class="profile-details">
                        @if ($user->followers->count() >= 3)
                            <h2 style="text-transform: capitalize;">{{ $user->name }}&check;</h2>
                        @else
                        ...
                        <div class="joined"><img class="calender" src="icon/calendar3.svg" alt="">
                            <p class="whitesmoke">{{ 'Joined ' . auth()->user()->created_at }}</p>
                        </div>
                        <div class="followers">
                            <p class="whitesmoke"><span
                                    style="color:black; font-weight:bold;">{{ $user->following->count() }} </span>Following
                            </p>
                            <p class="whitesmoke"><span
                                    style="color:black; font-weight:bold;">{{ $user->followers->count() }} </span>Followers
                            </p>
                        </div>
                    </div>
                    <div class="sections">
...
<div class="main-edit">
    <div class="edit-profile">
        <p style="cursor: pointer; font-size: 30px; width: 3%; margin-left: 90%; margin-bottom:8%" onclick="exit()">
            &times</p>
        <form action="/profile" method="POST" enctype="multipart/form-data">
            ...
            @enderror
            <br><br>
            <input class="edit" type="text" name="bio" id="" placeholder="Bio"
